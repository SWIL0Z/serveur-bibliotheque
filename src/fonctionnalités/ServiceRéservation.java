...
public class ServiceRéservation implements Runnable {
	...
	public ServiceRéservation(Socket s) {
		serveur = s;
	}
	...
	public void run() {
		...
		try {
			...
			socketOut.println("needsanswer$Entrez le numéro du document que vous souhaitez réserver : ");
			...
			doc.reserver(abo);
			socketOut.println("endsservice$Le " + doc.toString() + " a bien été réservé.");
		}
	...
	public String toString() {
		return "Service de réservation de document";
	}
